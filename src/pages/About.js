...
import molson from 'assets/images/about/molson.jpg'
import remmel from 'assets/images/about/remmel.jpg'
import camo from 'assets/images/about/camo.jpg'
import modelo from 'assets/images/about/modelo.jpg'
...
function DogProfile({ name, bio, img, prizes }) {
    return (
        <div className='desktop:max-w-[24rem] desktop:max-h-fit'>
            <div className='w-full max-w-[300px] overflow-clip rounded h-[50%] mb-2'>
