...
export default function PageHero({ headerText, bodyText, imgObj, comingSoonText, children }) {
    return (
        <div className='desktop:px-40 box-border'>
            <div className='grid desktop:grid-cols-[repeat(2,_1fr)] desktop:grid-rows-0 grid-rows-[1fr_auto] w-full desktop:flex-row flex-col desktop:justify-between desktop:gap-10 gap-6 mx-auto'>
