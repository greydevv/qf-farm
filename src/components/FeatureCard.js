...
export default function FeatureCard({ imgObj, titleText, bodyText, to }) {
    ...
    return (
        <Link href={ to }>
            <div className='cursor-pointer h-full desktop:max-h-fit desktop:max-w-[16rem] desktop:aspect-[5/7] max-h-20 h-full relative flex rounded overflow-clip overflow-hidden desktop:flex-col text-qf-white bg-qf-brown'>
